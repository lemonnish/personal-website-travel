...
{% include photo.html url="imitation-game.jpg" alt="front of the movie theatre for The Imitation Game" size="small" %}
{% include photo.html url="book-of-mormon.jpg" alt="front of the theatre for Book of Mormon" size="small" %}
