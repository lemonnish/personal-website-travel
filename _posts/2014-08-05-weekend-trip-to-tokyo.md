...
{% include photo.html url="meiji-gate.jpg" alt="wooden temple gate" size="med" %}
{% include photo.html url="street-corner.jpg" alt="buildings at a street corner" size="med" %}
{% include photo.html url="lamborghini.jpg" alt="Lamborghini" size="med" %}
{% include photo.html url="shibuya-crossing-people.jpg" alt="Shibuya crossing, filled with people" size="med" %}
</div>
...
<div class='img-gallery'>
{% include photo.html url="akihabara-electronics.jpg" alt="electronics store front" size="small" %}
{% include photo.html url="akihabara-claw-game.jpg" alt="game console" size="small" %}
{% include photo.html url="akihabara-green.jpg" alt="green store front" size="small" %}
</div>

Here are some more pictures of Akihabara as the sun was setting, taken outside of the metro station:

<div class='img-gallery'>
{% include photo.html url="akihabara-night.jpg" alt="street at night" size="med" %}
{% include photo.html url="akihabara-electronics-night.jpg" alt="electronics store front at night" size="med" %}
</div>
...
<div class='img-gallery'>
{% include photo.html url="theater-poster-2.jpg" alt="cast poster" size="small" %}
{% include photo.html url="theater-costumes.jpg" alt="costumes" size="small" %}
{% include photo.html url="theater-poster-1.jpg" alt="cast poster featuring a woman in purple" size="small" %}
</div>
...
<div class='img-gallery'>
{% include photo.html url="meiji-trees.jpg" alt="tree-covered walkway" size="med" %}
{% include photo.html url="meiji-courtyard.jpg" alt="shrine courtyard" size="med" %}
{% include photo.html url="meiji-wishes.jpg" alt="tree with wishes" size="large" %}
{% include photo.html url="meiji-shrine.jpg" alt="main shrine building" size="large" %}
</div>
...
<div class='img-gallery'>
{% include photo.html url="meiji-wine.jpg" alt="wine barrels" size="small" %}
{% include photo.html url="meiji-sake.jpg" alt="rice wine caskets" size="small" %}
</div>
...
<div class='img-gallery'>
{% include photo.html url="hachiko.jpg" alt="me standing next to Hachiko" size="large" %}
{% include photo.html url="tokyu.jpg" alt="Tokyu Hands store front" size="large" %}
{% include photo.html url="loft.jpg" alt="Loft store front" size="xlarge" %}
</div>
...
<div class='img-gallery'>
{% include photo.html url="shibuya-crossing-cars.jpg" alt="Shibuya crossing, with cars and a Transformer ad" size="med" %}
{% include photo.html url="transformers.jpg" alt="Transformers ad on the side of a building" size="med" %}
</div>
...
<div class='img-gallery'>
{% include photo.html url="shinjuku-robots.jpg" alt="robots on the back of a truck" size="med" %}
{% include photo.html url="shinjuku-1.jpg" alt="pedestrian street" size="med" %}
{% include photo.html url="shinjuku-2.jpg" alt="another pedestrian street" size="med" %}
{% include photo.html url="shinjuku-corner.jpg" alt="large video display on a street corner" size="med" %}
</div>
...
<div class='img-gallery'>
{% include photo.html url="odakyu-front.jpg" alt="Odakyu entrance" size="small" %}
{% include photo.html url="odakyu-1.jpg" alt="Odakyu, side view 1" size="small" %}
{% include photo.html url="odakyu-2.jpg" alt="Odakyu, side view 2" size="small" %}
</div>
...
<div class='img-gallery'>
{% include photo.html url="fruit-display.jpg" alt="fruit display" size="small" %}
{% include photo.html url="fruit-mango.jpg" alt="fruit display with mangoes" size="small" %}
{% include photo.html url="fruit-melon.jpg" alt="fruit display with melons" size="small" %}
</div>
...
<div class='img-gallery'>
{% include photo.html url="tamago-counter.jpg" alt="tamago chef at the front counter" size="small" %}
{% include photo.html url="tamago-chef.jpg" alt="tamago chef at work" size="small" %}
{% include photo.html url="tsukiji-outside.jpg" alt="people walking around the market" size="med" %}
{% include photo.html url="tsukiji-outside-stall.jpg" alt="dried fish display" size="med" %}
</div>

Inside the (deserted) fish market:

<div class='img-gallery'>
{% include photo.html url="tsukiji-inside-walkway.jpg" alt="empty walkway" size="med" %}
{% include photo.html url="tsukiji-inside-eels.jpg" alt="deserted eel stand" size="med" %}
</div>
...
<div class='img-gallery'>
{% include photo.html url="temple-roofline.jpg" alt="temple roofline" size="xlarge" %}
{% include photo.html url="temple-lantern.jpg" alt="temple lantern" size="med" %}
{% include photo.html url="temple-gate.jpg" alt="temple gate" size="med" %}
</div>
...
<div class='img-gallery'>
{% include photo.html url="asakusa-street.jpg" alt="quiet pedestrian street" size="small" %}
{% include photo.html url="asakusa-house.jpg" alt="house" size="small" %}
</div>
...
<div class='img-gallery'>
{% include photo.html url="kitchen-dishes.jpg" alt="store full of dishes" size="med" %}
{% include photo.html url="kitchen-cups.jpg" alt="architectural cups on the side of a building" size="med" %}
{% include photo.html url="kitchen-knives.jpg" alt="knife store" size="med" %}
{% include photo.html url="kitchen-goods.jpg" alt="kitchen utensils" size="med" %}
{% include photo.html url="kitchen-wax.jpg" alt="wax crepes" size="med" %}
{% include photo.html url="kitchen-wax-display.jpg" alt="wax ice cream and fruit" size="med" %}
</div>
